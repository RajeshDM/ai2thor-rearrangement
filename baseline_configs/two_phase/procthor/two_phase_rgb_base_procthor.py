...
from rearrange.pomdp_tasks import RearrangeTaskSamplerPOMDPProc
...
class TwoPhaseRGBBaseExperimentConfigProc(ExperimentConfig, abc.ABC):
    ...
    def make_sampler_fn(
        ...
        **kwargs,
        ...
        return RearrangeTaskSampler.from_fixed_dataset(
            ...
            epochs=epochs,
            expert_exploration_enabled=cls.EXPERT_EXPLORATION_ENABLED,
            **kwargs,
        )
    ...
    def make_POMDP_sampler_fn(
        ...
        **kwargs,
        ...
        return RearrangeTaskSamplerPOMDPProc.from_fixed_dataset(
            run_walkthrough_phase=True,
            run_unshuffle_phase=True,
            stage=stage,
            allowed_scenes=allowed_scenes,
            ...
            rearrange_env_kwargs=dict(
                ...
                **cls.REARRANGE_ENV_KWARGS,
                controller_kwargs={
                    "x_display": x_display,
                    #**cls.THOR_CONTROLLER_KWARGS,
                    'scene' : cls.THOR_CONTROLLER_KWARGS['scene'],
                    **(
                        {} if thor_controller_kwargs is None else thor_controller_kwargs
                    ),
    ...
    def stagewise_task_sampler_args(
        ...
        if allowed_scenes is not None:
            ...
            scenes = datagen_utils.get_scenes_procthor(stage)
